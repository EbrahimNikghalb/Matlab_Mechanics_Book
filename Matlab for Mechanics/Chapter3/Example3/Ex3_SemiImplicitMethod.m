...
%% input
data.m1 = 1;   %[kg] concentrate mass1
data.m2 = 2;   %[kg] concentrate mass2
data.l1 = 0.5; %[m] length of wire1
...
%% process
M = @(t,y)semiImpicitMty(t,y,data);
odeFun = @(t,y)semiImplicitFty(t,y,data);
option = odeset('Mass',M, ...
                'RelTol',1e-2,...
                'OutputFcn',@odeplot,...
                'OutputSel',[1 2]);
